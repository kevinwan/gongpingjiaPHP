$(document).ready(function() {
	...
	$(document).on("click", ".content .upload-img .l-font .close", function() {
		...
		var fileid = $('#uploadopcity1').attr("fileid");
		delImage(fileid);
	});
	...
	$(document).on("click", ".content .upload-img .e-font .close", function() {
		...
		var fileid = $('#uploadopcity2').attr("fileid");
		delImage(fileid);
	});
	...
	$(document).on("click", ".content .upload-img .n-shi .close", function() {
		...
		var fileid = $('#uploadopcity3').attr("fileid");
		delImage(fileid);
	});
	...
	$(document).on("click", ".content .upload-img .i-side .close", function() {
		...
		var fileid = $('#uploadopcity4').attr("fileid");
		delImage(fileid);
	});
	...
	$(document).on("click", ".content .upload-img .i-motor .close", function() {
		...
		var fileid = $('#uploadopcity5').attr("fileid");
		delImage(fileid);
	});
});
...
function delImage(fileid) {
	$.ajax({
		type: "POST",
		url: "/sell/index/delImage/",
		data: "fileId=" + fileid,
